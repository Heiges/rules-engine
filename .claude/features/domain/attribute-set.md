...
- Operationen: `add`, `remove`, `modify` (Beschreibung ändern), `find` (Optional), `contains`, `getAll`, `size`
...
- `modify` delegiert an `Attribute.setDescription`, um Änderungslogik nicht zu duplizieren
